...
async def admin_ai_settings_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if batch_status.get("is_running"):
        ...
        batch_running_notice = f"⏳ <b>یک عملیات تکمیل مشخصات در حال اجرا است ({b_cur} از {b_tot}).</b>\n\n"

    text = (
        f"🤖 <b>تنظیمات هوش مصنوعی مشخصات فنی کالاها:</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━\n"
        f"📌 <b>نحوه کارکرد سامانه:</b>\n"
        f"استخراج مشخصات هم به‌صورت <b>تقاضامحور (On-Demand)</b> هنگام کلیک روی محصول، و هم به‌صورت <b>تکمیل گروهی خودکار کاتالوگ</b> با گوگل جمینای انجام می‌شود.\n\n"
        f"▫️ <b>موتور فعال پیش‌فرض:</b>\n"
        f"<b>{provider_title}</b>\n\n"
        f"📊 <b>وضعیت کاتالوگ و مشخصات فنی:</b>\n"
        ...
        f"━━━━━━━━━━━━━━━━━━━━\n"
        f"👇 برای انتخاب موتور، تکمیل هوشمند کاتالوگ با جمینای یا ثبت کلیدها، دکمه‌های زیر را انتخاب نمایید:"
    )
    ...
    if batch_status.get("is_running"):
        kb_rows.insert(3, [InlineKeyboardButton("⏳ مشاهده وضعیت عملیات جاری / توقف", callback_data="adm_ai_batch_status")])
